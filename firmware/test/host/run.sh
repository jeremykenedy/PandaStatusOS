...
"$OUT-fx"
echo
gcc -std=c11 -Wall -Wextra -Wmisleading-indentation -Werror -I "$HERE/stub" -I "$HERE/../../main" -o "$OUT-rebind" "$HERE/rebind_test.c" "$HERE/../../main/ps_rebind.c"
"$OUT-rebind"
echo
...
"$OUT-netname"
echo
gcc -std=c11 -Wall -Wextra -Wmisleading-indentation -Werror -I "$HERE/stub" -I "$HERE/../../main" -o "$OUT-ssdp" "$HERE/ssdp_test.c" "$HERE/../../main/ps_ssdp.c"
"$OUT-ssdp"
