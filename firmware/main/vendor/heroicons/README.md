...
| sha256 of what ships | the per-file hashes below. The sprite the page carries is a build artifact that mixes this set with the project's own symbols under the project's licence (`docs/ARCHITECTURE.md`); its hash is therefore not evidence about this component or about the other set |

| File | sha256 |
|---|---|
| `outline/check-circle.svg` | `720aa6154ca2d170226559dd33c6125e5492f4d70d034e6426018d27359362ac` |
...
| `outline/exclamation-triangle.svg` | `3952df551d6c3b81b236831a5457931d9df1d8e5d9112e8f5de01b5c61e3144d` |
...
| `outline/pause-circle.svg` | `2e793cdf37f3b23475661b2920dd0c4431c102c550a49bead80482ea227012e0` |
| `outline/photo.svg` | `7097d901bd73841390a5a73f99193af198d3392bc84371e7063e520956eb7360` |
| `outline/scissors.svg` | `d27324a1b28daea3c109415ea34b6d4aea7c942f36b6969f36e0a4140b2a9fff` |
